...
<div class="row mb-3">
    <div class="col-md-4 col-sm-12">
        <label for="parentesco_aluno"><span class="text-danger">*</span>Parentesco com Aluno:</label>
        <input class="form-control" type="text" name="parentesco_aluno" id="parentesco_aluno" value="{{$responsavel->parentesco_aluno ?? old ('parentesco_aluno')}}"/>
    </div>
